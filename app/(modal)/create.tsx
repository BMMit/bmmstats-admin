    ...
    ActionSheetIOS.showActionSheetWithOptions(
      {
        ...
        tintColor: 'black',
        title:
          field === 'tagActuacion' ? 'Tag de actuación' : 'Tipo de actuación',
      },
      buttonIndex => {
        if (buttonIndex !== 0) {
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.input, { alignContent: 'flex-start' }]}>
            <DateTimePicker
              ...
              value={new Date(state.fecha.seconds * 1000)}
              mode={'datetime'}
              onChange={value =>
                handleDatePicker(new Date(value.nativeEvent.timestamp))
              }
            />
          </View>
        </View>
